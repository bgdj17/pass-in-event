            ...
            <Table>
                <thead>
                    <tr className='border-b border-white/10'>
                        <TableHeader>
                            <input type="checkbox" className="bg-black/20 rounded border-white/50" />
                        </TableHeader>
                    ...
                    {attendees.map(attendee => {
                        return (
                            <TableRow className='border-b border-white/10 hover:bg-white/5' key={attendee.id}>
                                <TableCell className='py-3 px-4 text-left text-sm text-zinc-300'>
                                    <input type="checkbox" className="bg-black/20 rounded border-white/50 " />
                                </TableCell >
                ...
                <tfoot>
                    <tr>
                        <TableCell colSpan={3} className='py-3 px-4 text-left text-sm text-zinc-300'>Mostrando {attendees.length} de {total}</TableCell>
                        <TableCell colSpan={3} className='py-3 px-4 text-right text-sm text-zinc-300'>
